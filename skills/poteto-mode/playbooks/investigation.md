...
3. Produce the `how`-shaped output (Overview / Key Concepts / How It Works / Where Things Live / Gotchas; Japanese: 概要 / 主な概念 / 仕組み / 関連ファイル / 注意点), or a recommendation with a tradeoffs table if the request is a decision between alternatives.
