...
Write the output for the user. Keep this section structure and its evidence requirements. For Japanese output, use 質問 / 対象コード / 確認できたこと / 根拠から推測できること / 他の仮説 / 分からないこと / 調査した情報源 / 確信度. Retain the tier labels `[Direct]`, `[Supported]`, `[Inferred]`, `[Speculative]`, `[Unknown]` and explain their meaning in Japanese where needed:
